...
<template>
    <div class="space-y-8">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 pb-6 border-b">
            <div>
                <h1 class="text-3xl font-bold text-gray-900">Tactical Overview</h1>
                <p class="text-gray-600 mt-1">Analyze your team's tactical distribution and balance</p>
            </div>
            ...
            <div class="flex flex-col sm:flex-row gap-3">
                <select 
                    v-model="filterSide" 
                    class="px-3 py-2 border border-gray-300 rounded-lg bg-white text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                >
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <Card class="bg-gradient-to-br from-slate-50 to-slate-100 border-slate-200">
                <CardContent class="p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm font-medium text-slate-600">Total Tactics</p>
                            <p class="text-3xl font-bold text-slate-900">{{ totalCounts.total }}</p>
                        </div>
            ...
            <Card class="bg-gradient-to-br from-blue-50 to-blue-100 border-blue-200">
                <CardContent class="p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm font-medium text-blue-700">CT Tactics</p>
                            <p class="text-3xl font-bold text-blue-900">{{ totalCounts.CT }}</p>
            ...
            <Card class="bg-gradient-to-br from-orange-50 to-orange-100 border-orange-200">
                <CardContent class="p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm font-medium text-orange-700">T Tactics</p>
                            <p class="text-3xl font-bold text-orange-900">{{ totalCounts.T }}</p>
            ...
            <Card class="bg-gradient-to-br from-gray-50 to-gray-100 border-gray-200">
                <CardContent class="p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm font-medium text-gray-600">Side Balance</p>
                            <p class="text-lg font-bold" :class="getBalanceColor(sideBalance)">
        ...
        <Card>
            <CardHeader>
                <div class="flex items-center justify-between">
                    <CardTitle class="text-2xl font-bold">Tactical Breakdown</CardTitle>
            ...
            <CardContent>
                <div class="space-y-4">
                    <div 
                        ...
                        :key="item.type"
                        class="group border-2 border-gray-100 rounded-xl p-6 hover:border-gray-200 hover:shadow-lg transition-all duration-200"
                        :class="{
                    ...
                    >
                        ...
                        <div class="flex items-center justify-between mb-4">
                            <div class="flex items-center space-x-3">
                                <div v-if="index === 0 && tacticBreakdown.length > 1" 
                                     class="flex items-center justify-center w-6 h-6 bg-yellow-400 text-yellow-900 rounded-full text-xs font-bold">
                                    #1
                                </div>
                                <h3 class="font-bold text-xl text-gray-900">{{ item.type }}</h3>
                            </div>
                            <div class="text-right">
                                <div class="text-2xl font-bold text-gray-900">{{ item.total }}</div>
                                <div class="text-sm text-gray-500">total tactics</div>
                            </div>
                        </div>
                        
                        <!-- Visual Distribution Bar -->
                        <div class="mb-4">
                            <div class="flex h-8 bg-gray-200 rounded-full overflow-hidden shadow-inner">
                                <div 
                                    v-if="item.CT > 0"
                                    class="bg-gradient-to-r from-blue-400 to-blue-600 flex items-center justify-center text-white text-sm font-bold transition-all duration-300 hover:from-blue-500 hover:to-blue-700"
                                ...
                                <div 
                                    v-if="item.T > 0"
                                    class="bg-gradient-to-r from-orange-400 to-orange-600 flex items-center justify-center text-white text-sm font-bold transition-all duration-300 hover:from-orange-500 hover:to-orange-700"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <!-- CT Stats -->
                            <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 transition-all duration-200 hover:bg-blue-100">
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center space-x-2">
                                        <div class="w-4 h-4 bg-blue-500 rounded-full"></div>
                                        <span class="font-semibold text-blue-800">Counter-Terrorist</span>
                                    </div>
                                    <span class="text-2xl font-bold text-blue-900">{{ item.CT }}</span>
                                </div>
                            ...
                            <!-- T Stats -->
                            <div class="bg-orange-50 border border-orange-200 rounded-lg p-4 transition-all duration-200 hover:bg-orange-100">
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center space-x-2">
                                        <div class="w-4 h-4 bg-orange-500 rounded-full"></div>
                                        <span class="font-semibold text-orange-800">Terrorist</span>
                                    </div>
                                    <span class="text-2xl font-bold text-orange-900">{{ item.T }}</span>
                                </div>
                                <div class="mt-2 flex justify-between items-center">
                ...
                <!-- Empty State -->
                <div v-if="tacticBreakdown.length === 0" class="text-center py-16">
                    <svg class="mx-auto h-12 w-12 text-gray-400 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"/>
                    </svg>
                    <h3 class="text-lg font-medium text-gray-900 mb-2">No tactics found</h3>
                    <p class="text-gray-600">Start adding tactics to see detailed breakdowns and analytics.</p>
                </div>
            </CardContent>
        </Card>
    </div>
